...
import handleMicrosoftSignIn from "@/providers/microsoft/Microsoft"
import handleYahooSignIn from "@/providers/yahoo/Yahoo"
          ...
          <div className="max-md:order-1 space-y-6">
            ...
            <div className="flex flex-wrap gap-6 ">
              ...
              <button
                ...
                type="button"
                className="p-2.5 flex items-center justify-center rounded-md text-white text-base tracking-wider font-semibold border-none outline-none bg-[#816bff] hover:bg-[#412BBD]">
                  <svg  width="22px"
                  fill="#fff"
                  className="inline shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M223.7 141.1 167 284.2 111 141.1H14.9L120.8 390.2 82.2 480h94.2L317.3 141.1zm105.4 135.8a58.2 58.2 0 1 0 58.2 58.2A58.2 58.2 0 0 0 329.1 276.9zM394.7 32l-93 223.5H406.4L499.1 32z"/></svg>
              ...
              <button
                ...
                type="button"
                className="p-2.5 flex items-center justify-center rounded-md text-white text-base tracking-wider font-semibold border-none outline-none bg-gray-100 hover:bg-gray-200">
             
                  <svg  width="22px"
                  fill="#fff"
                  className="inline shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23 23"><path fill="#f3f3f3" d="M0 0h23v23H0z"/><path fill="#f35325" d="M1 1h10v10H1z"/><path fill="#81bc06" d="M12 1h10v10H12z"/><path fill="#05a6f0" d="M1 12h10v10H1z"/><path fill="#ffba08" d="M12 12h10v10H12z"/></svg>
